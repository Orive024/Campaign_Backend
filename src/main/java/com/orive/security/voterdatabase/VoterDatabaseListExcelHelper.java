...
public class VoterDatabaseListExcelHelper {
	...
	//check that file is of excel type or not
			...
			public static List<VoterDatabaseList> convertExcelToListOfvoters(InputStream is){
				List<VoterDatabaseList> list = new ArrayList<>();
				...
				try 
				{
					...
					VoterDatabaseList voters = new VoterDatabaseList();
