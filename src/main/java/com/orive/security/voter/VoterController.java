...
public class VoterController {
 ...
 // Create a new Voter
    ...
    public ResponseEntity<List<VoterDto>> getAllVoter() {
        List<VoterDto> voters = voterService.getAllVoter();
    ...
    //get Voters by Pincode
	  @GetMapping("/voter/{pincode}")
	    public ResponseEntity<List<VoterDto>>  getVotersByPincode(@PathVariable("pincode") String pincode) {
	        List<VoterDto> voters = voterService.getVoterByPincode(pincode);
